...
const char* WIFI_SSID = "Glide0178348-2G";
const char* WIFI_PASSWORD = "CBF6C6828D";

// MQTT IP address of the PC/raspberry where you installed MQTT Server:
const char* MQTT_SERVER = "mqtt.coventry.ac.uk";
const char* MQTT_CLIENT_ID = "safwatn";  // unique client ID for this device
...
const std::string MQTT_TOPIC_NAME_PUBLISH   = MQTT_USERNAME + "/RABBIT/FromMicro";
const std::string MQTT_TOPIC_NAME_SUBSCRIBE = MQTT_USERNAME + "/RABBIT/FromServer";
